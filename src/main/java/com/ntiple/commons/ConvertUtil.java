...
import static com.ntiple.commons.ReflectionUtil.invokeGetter;
import static com.ntiple.commons.ReflectionUtil.isAssignable;
          ...
          if (name.startsWith("set") && name.length() > 3
            ...
            if (field != null) {
              if ((named = field.getAnnotation(NamedColumn.class)) != null) {
                ...
                for (String n : names) { methods.put(n, m); }
              }
              fname = field.getName();
            }
            methods.put(fname, m);
          ...
          if ((name.startsWith("is") && name.length() > 2
            ...
            if (val != null && !"class".equals(key)) {
              if (methods != null && methods.size() > 0) {
                ...
                if (method != null) { method.invoke(ret, new Object[] { val }); }
              } else if (Map.class.isAssignableFrom(type)) {
